...
var payrolljvgenerate = angular.module('generatepayrollJV', []);
...
*/
payrolljvgenerate.filter('sumOfValue', function () {
...
payrolljvgenerate.controller('GenaretePayrollJVController',['$scope','$http',function($scope,$http)
{
	...
	$scope.GenerateJVPayroll = function(details) {
		...
		var obj={
				...
				payroll_month:details.payroll_month
							...
							$http
									.post('/erp/Payroll/getJVPayrollTotal', obj)
									.then(
											function(response) {
												var sum = 0;
												...
												if ($scope.data1.successful) {
													...
													$scope.payrollDetails5 = $scope.data1.responseObject.JVpayroll5;
													$scope.payrollDetails6 = $scope.data1.responseObject.JVpayroll6;
													$scope.payrollDetails7 = $scope.data1.responseObject.JVpayroll7;
													$scope.payrollDetails8 = $scope.data1.responseObject.JVpayroll8;
													$scope.payrollDetails9 = $scope.data1.responseObject.JVpayroll9;
													$scope.payrollDetails10 = $scope.data1.responseObject.JVpayroll10;
													$scope.payrollDetails11 = $scope.data1.responseObject.JVpayroll11;
													$scope.payrollDetails12 = $scope.data1.responseObject.JVpayroll12;
...
$scope.RejectPayroll = function(UserData) {
	...
	$scope.getJVPayrollDetails = function(details) {
		console.log(details);
		var obj = {
		...
		console.log(obj);
		$http
				.post('/erp/Payroll/getJVPayrollDetails', obj)
				.then(
						function(response) {
							var sum = 0;
							$scope.data1 = response.data;
							if ($scope.data1.successful) {
								...
								$scope.payrollDetails = $scope.data1.responseObject.JVpayroll;
								$scope.payrollDetails1 = $scope.data1.responseObject.JVpayroll1;
								$scope.payrollDetails2 = $scope.data1.responseObject.JVpayroll2;
								$scope.payrollDetails3 = $scope.data1.responseObject.JVpayroll3;
								$scope.payrollDetails4 = $scope.data1.responseObject.JVpayroll4;
							/*	$scope.payrollDetails5 = $scope.data1.responseObject.JVpayroll5;
								$scope.payrollDetails6 = $scope.data1.responseObject.JVpayroll6;*/
