...
else if(UserData.primary_responsibility == null || UserData.primary_responsibility == '' || UserData.primary_responsibility == undefined)
 {
...
console.log("Server error while getting data");
						...
						$http.get('/erp/scheme/getPrimaryNames').then(function(response)
						{
							$scope.data = response.data;
							if($scope.data.successful)
							{
						...
						$http.get('/erp/scheme/getSecondaryNames').then(function(response) 
						{
							$scope.data = response.data;
							if($scope.data.successful)
							{
